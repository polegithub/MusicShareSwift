//
//  MsMeDetailViewController.swift
//  MusicShare
//
...
class MsMeDetailViewController: MsBaseViewController,UITableViewDataSource,UITableViewDelegate,PullTableViewDelegate {
    ...
    func headerView()->UIView{
        ...
        //
        //        }else if temp == 1{
        //            photoImg.backgroundColor = UIColor.blackColor()
        //        }else if temp == 2{
        ...
        //
        //        }else if temp == 4{
        //            photoImg.backgroundColor = UIColor.blueColor()
        //        }else{
        //            photoImg.backgroundColor = UIColor.orangeColor()
        //        }
        ...
        nameLabel.text = userMgr.userInfo.userName
