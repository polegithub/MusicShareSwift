...
class MsBaseWebViewController: MsBaseViewController,UIWebViewDelegate,UIActionSheetDelegate,WKNavigationDelegate {
    ...
    func configUI() {
        ...
        progressView.tintColor = UIColor.msCommonColor()
    ...
    func configBackItem() {
        ...
        backBtn.tintColor = UIColor.msCommonColor()
    ...
    func configMenuItem() {
        ...
        menuBtn.tintColor = UIColor.msCommonColor()
        menuBtn.setImage(menuImage, forState: .Normal)
        menuBtn.addTarget(self, action: "menuBtnPressed:", forControlEvents: .TouchUpInside)
    ...
    func configColseItem() {
        ...
        colseBtn.setTitleColor(UIColor.msCommonColor(), forState: .Normal)
        colseBtn.addTarget(self, action: "colseBtnPressed:", forControlEvents: .TouchUpInside)
        colseBtn.sizeToFit()
