//
//  MpTimelineViewController.swift
//  MusicShare
//
//  Created by poleness on 16/2/13.
...
class MpTimelineViewController: MsBaseViewController ,UITableViewDelegate,UITableViewDataSource{
    ...
    func initView(){
        ...
        self.tableView? .registerNib(UINib(nibName: "MpTimelineTableViewCell", bundle: nil), forCellReuseIdentifier: cellIdentifier)
    }
    ...
    */
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCellWithIdentifier(cellIdentifier) as! MpTimelineTableViewCell
